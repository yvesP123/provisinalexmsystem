...
<head>
  ...
  <title>Privisional Online Exam</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Privisional Online System</span>
      </a>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">General User Form </h5>
...
%>
              ...
              <div class="row mb-3">
                  <div class="col-sm-10">
                    <input type="text" name="id" class="form-control" value="<%=resultSet.getString("id")%>" hidden>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Sponsor Management System</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
