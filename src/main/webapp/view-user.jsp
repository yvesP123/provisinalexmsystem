          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                String connectionUrl = "jdbc:mysql://localhost:3306/onlinesystem";
                    ...
                    <td><%=rs.getString("phone") %></td>
                     <td><%=rs.getString("username") %></td>
                      <td><%=rs.getString("gender") %></td>
                       <td><a href="update-user.jsp?id=<%=rs.getString("id")%>">update</a>|<a href="delete-user.jsp?id=<%=rs.getString("id")%>">Delete</a></td>
